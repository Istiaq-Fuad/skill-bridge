    ...
    public ResponseEntity<?> generateJobDescription(
        ...
        try {
            ...
            IntelligentJobDescriptionService.JobDescriptionGenerationResult result = 
                    intelligentJobDescriptionService.generateJobDescription(
                            request.getJobTitle(),
                            request.getIndustry(),
    ...
    public ResponseEntity<?> optimizeJobDescription(
        ...
        try {
            ...
            IntelligentJobDescriptionService.JobDescriptionOptimizationResult result = 
                    intelligentJobDescriptionService.optimizeJobDescription(job);
    ...
    public ResponseEntity<?> suggestSkills(
        ...
        try {
            ...
            IntelligentJobDescriptionService.SkillSuggestionResult result = 
                    intelligentJobDescriptionService.suggestSkills(
                            request.getJobTitle(),
                            request.getIndustry(),
                            request.getExperienceLevel());
    ...
    public ResponseEntity<?> suggestSalaryRanges(
        ...
        try {
            ...
            IntelligentJobDescriptionService.SalarySuggestionResult result = 
                    intelligentJobDescriptionService.suggestSalaryRanges(
                            request.getJobTitle(),
                            request.getIndustry(),
                            request.getExperienceLevel(),
                            request.getLocation());
    ...
    public ResponseEntity<?> enhanceJobPost(
        ...
        try {
            ...
            if (enhancements.getTitle() != null) {
                job.setPostProfile(enhancements.getTitle());
            }
            
            if (enhancements.getDescription() != null) {
                job.setPostDesc(enhancements.getDescription());
            }
            ...
            if (enhancements.getEmploymentType() != null) {
                job.setEmploymentType(enhancements.getEmploymentType());
            }
            
            if (enhancements.getSalaryMin() != null) {
                job.setSalaryMin(enhancements.getSalaryMin());
            }
            
            if (enhancements.getSalaryMax() != null) {
                job.setSalaryMax(enhancements.getSalaryMax());
            }
            
            // Update the job
            JobPost updatedJob = jobService.updateJob(job);
